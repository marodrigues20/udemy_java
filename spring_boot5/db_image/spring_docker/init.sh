...
psql -U postgres springcourse <<-EOSQL
    ...
    \i /usr/app/db-spring_security_demo_plaintext/spring_security_demo_plaintext_public_authorities.sql
    \i /usr/app/db-spring_security_demo_plaintext/spring_security_demo_plaintext_public_users.sql
