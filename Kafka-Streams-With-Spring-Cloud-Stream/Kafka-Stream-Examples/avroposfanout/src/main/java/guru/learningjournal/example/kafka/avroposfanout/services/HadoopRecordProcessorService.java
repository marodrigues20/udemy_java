package guru.learningjournal.example.kafka.avroposfanout.services;

import guru.learningjournal.example.kafka.avroposfanout.bindings.PosListenerBinding;
import guru.learningjournal.example.kafka.avroposfanout.model.HadoopRecord;
