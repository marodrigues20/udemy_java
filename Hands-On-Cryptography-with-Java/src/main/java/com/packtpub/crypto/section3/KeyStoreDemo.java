...
public class KeyStoreDemo {
  ...
  public static void main(String[] args)
      throws IOException, KeyStoreException, NoSuchAlgorithmException, CertificateException, OperatorCreationException {
  ...
  /**
   * It's annoying to have to wrap KeyPairs with Certificates, but this is "easier" for you to know
